<div class="main-settings-step-8">
    <div class="main-settings-data-personal">
        <div class="d-flex aic mt-1">
            <h3 class="h3-title mr-2"><strong>ASPECTOS ADICIONALES</strong></h3>
        ...
        <div class="fadeInLeft">
            ...
            <div class="input-form user-data normal-my">
                <label class="txt-field">
                    ...
                    <input type="text" name="linkVideoName" value="Aspectos adicionales"
                        style="color: silver; font-weight: bold;" />
                </label>
            </div>
            <h4 class="subtitle normal"><strong>Añadir más información</strong></h4>
            <p class="mt-10">Administrar datos en la sección de aspectos adicionales</p>
            <hr class="hr-color-primary-light">
            <div class="list-settings-step step-one-cv">
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Fumador</span>
                ...
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Deportes Prácticados</span>
                    <label class="field-switch switch-normal" field="deportes_practicados_inEightCv">
                        <input type="checkbox" checked>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Libros Leídos</span>
                    <label class="field-switch switch-normal" field="libros_leidos_inEightCv">
                        <input type="checkbox" checked>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Aficiones y Hobbies</span>
                    <label class="field-switch switch-normal" field="aficiones_hobbies_inEightCv">
                        <input type="checkbox" checked>
                        <span class="slider round"></span>
                    </label>
                </div>
    ...
    <div class="settings-item">
        ...
        <div class="tabs-content-settings">
            <div class="tab-content-settings">
                ...
                <h4 class="subtitle normal"><strong>Fumador</strong></h4>
                <hr class="my-2">
                ...
                <h4 class="subtitle normal"><strong>Deportes prácticados</strong></h4>
                <hr class="my-2">
                ...
                <h4 class="subtitle normal"><strong>Horas prácticadas al día</strong></h4>
                <hr class="my-2">
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rem necessitatibus, eum blanditiis explicabo veniam nobis quod iste obcaecati voluptates nesciunt aut dolor harum iusto sequi reiciendis laboriosam ea modi optio. 
                </p>
                <h4 class="subtitle normal"><strong>Libros leídos</strong></h4>
                <hr class="my-2">
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rem necessitatibus, eum blanditiis explicabo veniam nobis quod iste obcaecati voluptates nesciunt aut dolor harum iusto sequi reiciendis laboriosam ea modi optio. 
                </p>
                ...
                <h4 class="subtitle normal"><strong>¿Qué extraes de la lectura de este libro?</strong></h4>
                <hr class="my-2">
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rem necessitatibus, eum blanditiis explicabo veniam nobis quod iste obcaecati voluptates nesciunt aut dolor harum iusto sequi reiciendis laboriosam ea modi optio. 
                </p>
                <h4 class="subtitle normal"><strong>Aficiones y Hobbies</strong></h4>
                <hr class="my-2">
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rem necessitatibus, eum blanditiis explicabo veniam nobis quod iste obcaecati voluptates nesciunt aut dolor harum iusto sequi reiciendis laboriosam ea modi optio. 
                </p>
                <h4 class="subtitle normal"><strong>Asiduidad en la práctica</strong></h4>
                <hr class="my-2">
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rem necessitatibus, eum blanditiis explicabo veniam nobis quod iste obcaecati voluptates nesciunt aut dolor harum iusto sequi reiciendis laboriosam ea modi optio. 
                </p>
                <h4 class="subtitle normal"><strong>Horas prácticadas por día</strong></h4>
                <hr class="my-2">
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rem necessitatibus, eum blanditiis explicabo veniam nobis quod iste obcaecati voluptates nesciunt aut dolor harum iusto sequi reiciendis laboriosam ea modi optio. 
                </p>
            </div>
            <div class="tab-content-settings">
                <div class="process-cv-8">
                    <div class="card-pink mt-3">
                        <i class="material-icons-outlined mr-10">error_outline</i>
                        <span>
                            En la sección <strong>Hobbies / Hábitos</strong> faltan algunos datos. Para mejorar
                    ...
                    <div class="d-flex aic size-normal p-10 mt-3">
                        ...
                        <strong>Hobbies / Hábitos</strong>
                    </div>
                    <div class="toasts-smalls-8"></div>
                </div>
                <div class="cv-completed-8">
