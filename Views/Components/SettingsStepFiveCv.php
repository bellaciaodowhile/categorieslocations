<div class="main-settings-step-5">
    <div class="main-settings-data-personal">
        <div class="d-flex aic mt-1">
            <h3 class="h3-title mr-2"><strong>CURSOS ADICIONALES</strong></h3>
        ...
        <div class="fadeInLeft">
            ...
            <div class="input-form user-data normal-my">
                <label class="txt-field">
                    ...
                    <input type="text" name="linkVideoName" value="Cursos adicionales"
                        style="color: silver; font-weight: bold;" />
                </label>
            </div>
            <h4 class="subtitle normal"><strong>Añadir más información</strong></h4>
            <p class="mt-10">Administrar datos en la sección de cursos adicionales</p>
            <hr class="hr-color-primary-light">
        

            <div class="list-settings-step step-one-cv">
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Fecha</span>
                ...
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Tipo de curso</span>
                    <div class="field-switch item-lock">
                        <i class="material-icons-outlined">lock</i>
                        <span>Bloqueado</span>
                    </div>
                ...
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Calificación final</span>
                    <label class="field-switch switch-normal" field="calificacionFinal_fiveCv">
                        <input type="checkbox" checked>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Nombre del centro del curso</span>
                    <div class="field-switch item-lock">
                        <i class="material-icons-outlined">lock</i>
                        <span>Bloqueado</span>
                    </div>
                ...
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Formato de estudios</span>
                    <label class="field-switch switch-normal" field="formato_estudios_fiveCv">
                        <input type="checkbox" checked>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Dirección del centro</span>
                    <label class="field-switch switch-normal" field="direccion_centro_fiveCv">
                        <input type="checkbox" checked>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Dirección del centro (Línea 2)</span>
                    <label class="field-switch switch-normal" field="direccion2_centro_fiveCv">
                        <input type="checkbox" checked>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Código postal</span>
                    <label class="field-switch switch-normal" field="codigo_postal_fiveCv">
                        <input type="checkbox" checked>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Población</span>
                    <label class="field-switch switch-normal" field="poblacion_fiveCv">
                        <input type="checkbox" checked>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Provincia</span>
                    <label class="field-switch switch-normal" field="provincia_fiveCv">
                        <input type="checkbox" checked>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Sitio web del centro del curso</span>
                    <label class="field-switch switch-normal" field="web_fiveCv">
                        <input type="checkbox" checked>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Teléfono del centro del curso</span>
                    <label class="field-switch switch-normal" field="tel_fiveCv">
                        <input type="checkbox" checked>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Email del centro del curso</span>
                    <label class="field-switch switch-normal" field="email_fiveCv">
                        <input type="checkbox" checked>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Diplomas, Premios y Honores</span>
                    <label class="field-switch switch-normal" field="diplomas_fiveCv">
                        <input type="checkbox" checked>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="item-list-settings-step">
                    <span class="title-list-settings-step">Observaciones</span>
                    <label class="field-switch switch-normal" field="observaciones_fiveCv">
                        <input type="checkbox" checked>
                        <span class="slider round"></span>
                    </label>
                </div>
    ...
    <div class="settings-item">
        ...
        <div class="tabs-content-settings">
            <div class="tab-content-settings">
                ...
                <hr class="my-2">
                <p>En esta sección podemos encontrar diversos registros los cuales se dividen en apartados particulares según el contenido. 
                </p>
                <h4 class="subtitle normal"><strong>Tipo de curso</strong></h4>
                <hr class="my-2">
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rem necessitatibus, eum blanditiis explicabo veniam nobis quod iste obcaecati voluptates nesciunt aut dolor harum iusto sequi reiciendis laboriosam ea modi optio. 
                </p>
                ...
                <h4 class="subtitle normal"><strong>Dirección del centro (Línea 2)</strong></h4>
                <hr class="my-2">
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rem necessitatibus, eum blanditiis explicabo veniam nobis quod iste obcaecati voluptates nesciunt aut dolor harum iusto sequi reiciendis laboriosam ea modi optio. 
                </p>
            ...
            <div class="tab-content-settings">
                <div class="process-cv-5">
                    <div class="card-pink mt-3">
                        <i class="material-icons-outlined mr-10">error_outline</i>
                        <span>
                            En la sección <strong>Cursos adicionales</strong> faltan algunos datos. Para mejorar
                    ...
                    <div class="d-flex aic size-normal p-10 mt-3">
                        ...
                        <strong>Cursos adicionales</strong>
                    </div>
                    <!-- <div class="toast-small">
                        <i class="material-icons-outlined mr-10">error_outline</i>
                        Añade tu nombre en Cursos adicionales
                    </div>
                    <div class="toast-small">
                        <i class="material-icons-outlined mr-10">error_outline</i>
                        Añade tus apellidos en Cursos adicionales
                    </div> -->
                    <div class="toasts-smalls-5"></div>
                </div>
                <div class="cv-completed-5">
